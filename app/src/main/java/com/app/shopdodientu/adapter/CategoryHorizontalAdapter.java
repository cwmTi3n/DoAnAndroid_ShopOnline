...
public class CategoryHorizontalAdapter  extends RecyclerView.Adapter<CategoryHorizontalAdapter.ViewHolder>{
    ...
    public CategoryHorizontalAdapter(Context context, List<CategoryModel> categoryModels) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemView = li.inflate(R.layout.catalog, parent, false);
        return new CategoryHorizontalAdapter.ViewHolder(itemView);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            super(itemView);
            imvCategory = (ImageView) itemView.findViewById(R.id.imgCategory);
            tvCategory = (TextView) itemView.findViewById(R.id.tvCateName);
...
//                    context.startActivity(intent);
                    onCategoryClickListener.onCategoryClick(categoryModels.get(getAdapterPosition()));
                }
            });
        }
    }
